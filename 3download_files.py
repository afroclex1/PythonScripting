...
# Create translated-files directory
translated_files_dir = 'C:\\Users\\Alex Caffrey\\PycharmProjects\\SmartlingAPI\\Test 2\\translated-files'
            ...
            for file_name in FILE_LIST:
                for locale_id in LOCALE_LIST:
                    ...
                    if download_response.status_code == 200:
                        ...
                        translated_file_path = os.path.join(translated_files_dir, translated_file_name)
